...
public class LeaderImpl {
    ...
    public TGetTableMetaResponse getTableMeta(TGetTableMetaRequest request) {
        ...
        try {
            ...
            if (partitionInfo.isRangePartition()) {
                ...
                for (Column column : MetaUtils.getColumnsByPhysicalName(olapTable,
            ...
            for (Index index : olapTable.getIndexes()) {
                ...
                for (String column : MetaUtils.getColumnNamesByPhysicalNames(olapTable, index.getColumns())) {
    ...
    private static TDistributionDesc getDistributionDesc(OlapTable olapTable) {
        ...
        if (distributionInfo.getType() == DistributionInfoType.HASH) {
            ...
            for (Column column : MetaUtils.getColumnsByPhysicalName(
